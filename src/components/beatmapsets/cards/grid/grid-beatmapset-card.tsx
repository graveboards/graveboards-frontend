...
import {GridBeatmapsetCardDetails} from "@/components/beatmapsets/cards/grid/grid-beatmapset-card-details";
            ...
            <div
                ...
                <div
                    ...
                    <Button
                        ...
                        className="px-1.5 gap-1 h-8.5 font-semibold text-sm box-border"
                    >
                ...
                <div
                    className={clsx("absolute w-full h-full backdrop-blur backdrop-brightness-75 -mb-2.5 -mr-2.5 duration-300 delay-300 z-0", !hover && "opacity-0 delay-0")}/>
            </div>
            <div
