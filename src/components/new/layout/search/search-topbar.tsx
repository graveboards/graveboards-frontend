...
const SearchTopbar = () => {
    return (
        <div
            className="flex flex-1 items-center gap-4 sm:px-5 sm:pt-9 sm:pb-5 p-5 sticky top-0 z-20 backdrop-blur bg-white dark:bg-transparent dark:backdrop-brightness-[0.1]">
            <TopbarToggle/>
