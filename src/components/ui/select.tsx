...
const Select = <T, >({
    ...
    return (
        ...
        >
            ...
            {open && (
                <div
                    className="absolute overflow-y-scroll sm:mt-2 flex flex-col z-50 bg-tertiary-100 dark:bg-tertiary-900 sm:border border-t-0 sm:border-t border-tertiary-400 dark:border-tertiary-700 border rounded-b-lg sm:rounded-lg min-w-full max-h-[19.25rem] snap-y">
